...
//        dd($gambar);
    ...
    public function Save(Request $minta){
        ...
        $akreditasi = $minta['SC_akreditasi'];
        $psg15low   = (float)$minta['SC_psgrade15low'];
        $psg15high  = (float)$minta['SC_psgrade15high'];
        $psg16low   = (float)$minta['SC_psgrade16low'];
        $psg16high  = (float)$minta['SC_psgrade16high'];
...
//        dd($sekolah)
        ...
        $sekolah->akreditasi    = $akreditasi;
        $sekolah->psgrade15low  = $psg15low;
        $sekolah->psgrade15high = $psg15high;
        $sekolah->psgrade16low  = $psg16low;
        $sekolah->psgrade16high = $psg16high;
        $sekolah->kdpos         = $kdpos;
